...
from .views import HomePage, CoursesPage, get_book_recommendation, LecturerManageCoursePage, AboutUsPage,  CourseDetailPage, BlogPage, BlogDetailPage, LoginPage,SignUpPage, StaffLoginPage, StaffSignUpPage
...
urlpatterns = [
    ...
    path("courses/<slug:course_slug>/create-broadcast/", BroadCastView, name="broadcast"),
    path("courses/<slug:slug>/", CourseDetailPage.as_view(), name="course-detail"),
    path("courses/<slug:course_slug>/recommendations/", get_book_recommendation, name="get-book-recommendation"),
